...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wider",
    {
        variants: {
            variant: {
                default: "bg-foreground text-background hover:bg-brand-silver hover:text-white border border-foreground",
                destructive:
                    "bg-red-600 text-white hover:bg-red-700 border border-red-500",
                outline:
                    "border border-brand-gray bg-transparent hover:bg-brand-dark text-foreground hover:text-foreground hover:border-foreground",
                secondary:
                    "bg-brand-dark text-foreground hover:bg-brand-gray border border-brand-gray",
                ghost: "hover:bg-brand-dark hover:text-foreground",
